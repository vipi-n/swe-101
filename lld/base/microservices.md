...
> **Moved to dedicated file:** See [DESIGN_PATTERNS.md](DESIGN_PATTERNS.md) for all creational, structural, and behavioral design patterns with implementation rules, "what goes wrong without it" explanations, and Java examples.
